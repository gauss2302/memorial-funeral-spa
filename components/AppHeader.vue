              ...
              <ul class="dropdown-menu" :class="{ 'show': isDropdownOpen }">
                ...
                <li>
                  <a
                      href="#cremation"
                      class="dropdown-link"
                      @click="scrollToSection('cremation')"
                  >
                    Кремация
                  </a>
                </li>
                <li>
                  <a
                      href="#memorial"
                      class="dropdown-link"
                      @click="scrollToSection('memorial')"
                  >
                    Памятники
                  </a>
                </li>
...
const updateActiveSection = () => {
  const sections = ['hero', 'services', 'about', 'advantages', 'contact']
  const scrollPosition = window.scrollY + 100 // offset для хедера
...
.nav-link[href="#services"]:where(.active-services),
.nav-link[href="#about"]:where(.active-about),
.nav-link[href="#advantages"]:where(.active-advantages),
.nav-link[href="#contact"]:where(.active-contact) {
  color: var(--color-accent);
  background-color: var(--color-background-alt);
}
